...
CREATE_USER_URL = reverse('user:create') # url to : create_user
...
class  PublicUserAPITest(TestCase):
    """Test the user API publics"""

    def setUp(self):
        self.client = APIClient()

    def test_create_valid_user_success(self):
        """Testing create user with valid payload is succeessful"""
        payload = {
...
class  PrivateUserApiTest(TestCase):
    ...
    def setUp(self):
        ...
        self.client = APIClient()
        self.client.force_authenticate(user=self.user)  # to simulate auth
